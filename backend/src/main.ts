...
app.use("/api/devices", measuringDeviceRoutes);
app.use("/api/plans", calibrationPlanRoutes);
app.use("/api/certificates", calibrationCertificateRoutes);
app.use("/api/vendors", calibrationVendorRoutes);
app.use("/api/alerts", overdueAlertRoutes);
